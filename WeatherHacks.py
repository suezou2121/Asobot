...
def WeatherReport(msg):
	...
	#msg.Chat.SendMessage(forecast["dateLabel"] + "(" + forecast["date"]+ u") の天気は " + forecast["telop"] + u" です。")
        ...
        print u"" + forecast["dateLabel"] + "(" + forecast["date"]+ u") の天気は " + forecast["telop"] + u" です。"
		...
		print u"" + forecast["dateLabel"] + "(" + forecast["date"]+ u") の最高気温は " + forecast["temperature"]["max"]["celsius"] + u"℃ です。最低気温は " + forecast["temperature"]["min"]["celsius"] + u"℃ です。"
            ...
            print u"" + forecast["dateLabel"] + "(" + forecast["date"]+ u") の気温は、まだ発表されていません。"
